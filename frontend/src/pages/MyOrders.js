          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filteredOrders.map((order) => {
                const status = normalizeStatus(order.status);
                return (
                  <div key={order._id} className="bg-riderDark/90 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-riderBlue/10 flex flex-col lg:flex-row justify-between gap-5">
                    ...
                    <div className="lg:w-64 flex flex-col gap-3">
                      <button
                        ...
                        className="bg-gray-800 text-white px-4 py-3 rounded-xl font-bold hover:bg-gray-700 transition-colors"
                      >
                        View Receipt
                      </button>
