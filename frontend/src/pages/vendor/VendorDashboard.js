...
export default function VendorDashboard() {
    ...
    return (
        <div className="min-h-screen bg-riderBlack text-riderLight font-sans">
            <Navbar />

            <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 pt-24">
                {/* Header */}
                <div className="bg-riderBlack/80 backdrop-blur-md border border-riderBlue/10 p-6 rounded-3xl shadow-xl mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div>
                    ...
                    <div className="flex gap-4">
                        <div className="flex items-center gap-2 bg-green-500/10 px-4 py-2 rounded-full border border-green-500/20">
                            ...
                            <span className="text-green-600 font-bold text-sm">Store Open</span>
                        </div>
                        <button className="bg-riderDark/50 border border-riderBlue/20 hover:bg-riderDark px-4 py-2 rounded-xl text-sm font-bold transition-all">
                            Settings
                        </button>
                    </div>
                </div>
...
function StatCard({ title, value, icon }) {
    return (
        <div className="bg-riderBlack/60 backdrop-blur-md p-6 rounded-2xl border border-riderBlue/5 shadow-lg">
            <div className="flex justify-between items-start mb-4">
                <h3 className="text-gray-500 font-bold text-sm uppercase tracking-wider">{title}</h3>
                <span className="text-2xl">{icon}</span>
            </div>
            <p className="text-4xl font-extrabold text-riderLight">{value}</p>
        </div>
    )
}
