...
const STATUS_MESSAGES = {
  ...
  [ORDER_STATUS.READY_FOR_PICKUP]: "Order is ready for pickup",
  [ORDER_STATUS.PENDING_RIDER]: "Looking for a rider",
  [ORDER_STATUS.RIDER_ASSIGNED]: "A rider has been assigned to your order",
...
const ALLOWED_TRANSITIONS = {
  ...
  [ORDER_STATUS.PAYMENT_CONFIRMED]: [ORDER_STATUS.PAID, ORDER_STATUS.PROCESSING, ORDER_STATUS.PREPARING, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.PAID]: [ORDER_STATUS.PROCESSING, ORDER_STATUS.PREPARING, ORDER_STATUS.READY_FOR_PICKUP, ORDER_STATUS.PENDING_RIDER, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.PROCESSING]: [ORDER_STATUS.PREPARING, ORDER_STATUS.READY_FOR_PICKUP, ORDER_STATUS.RIDER_ASSIGNED, ORDER_STATUS.ON_THE_WAY, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.PREPARING]: [ORDER_STATUS.READY_FOR_PICKUP, ORDER_STATUS.RIDER_ASSIGNED, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.READY_FOR_PICKUP]: [ORDER_STATUS.PENDING_RIDER, ORDER_STATUS.RIDER_ASSIGNED, ORDER_STATUS.ON_THE_WAY, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.PENDING_RIDER]: [ORDER_STATUS.RIDER_ASSIGNED, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.RIDER_ASSIGNED]: [ORDER_STATUS.ON_THE_WAY, ORDER_STATUS.PENDING_RIDER, ORDER_STATUS.READY_FOR_PICKUP, ORDER_STATUS.CANCELLED],
  ...
  try {
    ...
    const userNotifications = {
      ...
      [ORDER_STATUS.PREPARING]: {
        ...
        body: "The store is preparing your order for pickup.",
        eventType: "ORDER_PREPARING",
        deepLink: "/orders",
      },
      [ORDER_STATUS.READY_FOR_PICKUP]: {
        title: "Ready for pickup",
        body: "Your order is packed and ready for a rider.",
        eventType: "ORDER_READY_FOR_PICKUP",
        deepLink: "/orders",
      },
      [ORDER_STATUS.PENDING_RIDER]: {
        title: "Finding a rider",
        body: "We are looking for the best rider for your order.",
        eventType: "ORDER_PENDING_RIDER",
        deepLink: "/orders",
      },
      [ORDER_STATUS.RIDER_ASSIGNED]: {
        title: "Rider assigned",
        body: "A rider has received your delivery request.",
        eventType: "ORDER_RIDER_ASSIGNED",
        deepLink: "/orders",
      },
