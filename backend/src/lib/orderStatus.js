...
const STATUS_MESSAGES = {
  ...
  [ORDER_STATUS.PENDING_RIDER]: "Waiting for rider availability",
...
const ALLOWED_TRANSITIONS = {
  ...
  [ORDER_STATUS.PAYMENT_PENDING]: [ORDER_STATUS.PAYMENT_CONFIRMED, ORDER_STATUS.PENDING_RIDER, ORDER_STATUS.RIDER_ASSIGNED, ORDER_STATUS.CANCELLED],
  ...
  [ORDER_STATUS.READY_FOR_PICKUP]: [ORDER_STATUS.RIDER_ASSIGNED, ORDER_STATUS.PENDING_RIDER],
  [ORDER_STATUS.PENDING_RIDER]: [ORDER_STATUS.RIDER_ASSIGNED, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.RIDER_ASSIGNED]: [ORDER_STATUS.ON_THE_WAY, ORDER_STATUS.READY_FOR_PICKUP, ORDER_STATUS.PENDING_RIDER],
...
const LEGACY_STATUS_MAP = {
  ...
  pending_rider: ORDER_STATUS.PENDING_RIDER,
  ...
  try {
    ...
    const userNotifications = {
      ...
      [ORDER_STATUS.PENDING_RIDER]: {
        ...
        body: "No rider available at the moment. We will assign one shortly.",
